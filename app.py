...
APP_VERSION = "V9.2-STOCKS-RIDES+RIDE-MANAGER-V3.1+EARLY-WATCH-V4+PROFIT-PROTECTION-V5+WINNER-PATH-RESEARCH-V6.1-FAST"
...
if ub:
    ...
    if results.empty:
        ...
        try:
            ...
            if overview:
                st.markdown("### ⚡🏇 V9 Winner Path Research V6.1 FAST")
                st.caption(
            ...
            if raw:
                st.download_button(
                    "🏇 Download Winner Path V6.1 FAST Summary CSV",
                    raw,
            ...
            if raw2:
                st.download_button(
                    "🔬 Download Winner Path V6.1 FAST Trade-Level CSV",
                    raw2,
