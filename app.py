...
APP_VERSION = "V8.9-STOCKS-RIDES+EARLY-WATCH-V4+FAST-SCANNER"
...
st.caption("FAST scanner • concurrent market-data retrieval • V9 BUY/RIDE/EXIT and Early Watch V4 logic unchanged. Start with 25 stocks for the quickest live check.")
...
if "scan" in st.session_state:
    ...
    if not df.empty:
        ...
        d.metric("🔴 EXIT", int((flow=="EXIT").sum()))
