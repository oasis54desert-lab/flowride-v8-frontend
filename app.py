...
APP_VERSION = "V8.6C-STOCKS-RIDES-SIGNAL-ALIGNED-FLOW"
...
if analysis:
    ...
    if state == "EXIT":
        ...
        # Do not show supportive/bullish 'why' factors during EXIT.
        # Cautions may still be shown because they are not presented as positive factors.
        if cautions:
            st.markdown("**Current cautions:**  \n" + "  \n".join([f"⚠️ {x}" for x in cautions[:3]]))
