...
APP_VERSION = "V9.2-STOCKS-RIDES+RIDE-MANAGER-V3.1+EARLY-WATCH-V4+PROFIT-PROTECTION-V5+WINNER-PATH-V6+DYNAMIC-WINNER-MANAGER-V7-RESEARCH-FIX1"
...
if ub:
    ...
    if results.empty:
        ...
        try:
            ...
            if variants:
                st.markdown("### 🏇🛡️ Dynamic Winner Manager V7 Research")
                st.caption(
