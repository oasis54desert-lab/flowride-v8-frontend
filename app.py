...
with ub2:
    ub_limit = st.selectbox("Stocks to test", [25, 50, 100], index=0, key="ub_limit")
with ub3:
...
if st.button("🧪 RUN STRATEGY VALIDATION", type="primary", use_container_width=True):
    try:
        with st.spinner(f"Testing up to {ub_limit} representative {ub_exchange} stocks and measuring 5D / 10D / 20D BUY outcomes..."):
